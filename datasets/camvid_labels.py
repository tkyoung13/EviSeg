...
labels = [
    ...
    Label(  'Sky'                  ,  0 ,        0 , 'Sky'             , 0       , False        , False        , (128,128,128) ),
    Label(  'Building'             ,  1 ,        1 , 'Building'        , 1       , False        , False        , (128,  0,  0) ),
    Label(  'Column-Pole'          ,  2 ,        2 , 'Column-Pole'     , 2       , False        , False        , (192,192,128) ),
    Label(  'Road'                 ,  3 ,        3 , 'Road'            , 3       , False        , False        , (128, 64,128) ),
    Label(  'Sidewalk'             ,  4 ,        4 , 'Sidewalk'        , 4       , False        , False        , (  0,  0,192) ),
    Label(  'Tree'                 ,  5 ,        5 , 'Tree'            , 5       , False        , False        , (128,128,  0) ),
    Label(  'Sign-Symbol'          ,  6 ,        6 , 'Sign-Symbol'     , 6       , False        , False        , (192,128,128) ),
    Label(  'Fence'                ,  7 ,        7 , 'Fence'           , 7       , False        , False        , ( 64, 64,128) ),
    Label(  'Car'                  ,  8 ,        8 , 'Car'             , 8       , False        , False        , ( 64,  0,128) ),
    Label(  'Pedestrain'           ,  9 ,        9 , 'Pedestrain'      , 9       , False        , False        , ( 64, 64,  0) ),
    Label(  'Bicyclist'            , 10 ,       10 , 'Bicyclist'       , 10      , False        , False        , (  0,128,192) ),
    Label(  'Void'                 , 11 ,       11 , 'Void'            , 11      , False        , False        , (  0,  0,  0) ),
